...
parser = argparse.ArgumentParser(description='Tweets sentiment classifier v0.02')
parser.add_argument('sentence', metavar='Words sentence from tweet', type=str, nargs='+',
                    help='Input your Tweet to analize it sentiment')
args = parser.parse_args()
# this sentence uses to generante various sentences
entered_tweet = []
if args.sentence:
    entered_tweet = args.sentence
entered_tweet = " ".join(entered_tweet)
print(entered_tweet)
n = ['id', 'date', 'name', 'text', 'typr', 'rep', 'rtw', 'faw', 'stcount', 'foll', 'frien', 'listcount']
data_positive = pd.read_csv('G:\\sentiment-analysis-of-tweets-in-russian\\positive.csv', sep=';', error_bad_lines=False, names=n, usecols=['text'])
data_negative = pd.read_csv('G:\\sentiment-analysis-of-tweets-in-russian\\negative.csv', sep=';', error_bad_lines=False, names=n, usecols=['text'])
...
# x_test.append(entered_tweet)
x_test = [entered_tweet]
...
w2v_model = Word2Vec.load('G:\\sentiment-analysis-of-tweets-in-russian\\w2v\\tweets_model.w2v')
...
# checkpoint = ModelCheckpoint("G:\\sentiment-analysis-of-tweets-in-russian\\cnn\\cnn-frozen-embeddings-{epoch:02d}-{val_f1:.2f}.hdf5", 
...
# model.load_weights('G:\\sentiment-analysis-of-tweets-in-russian\\cnn\\cnn-frozen-embeddings-09-0.77.hdf5')
...
# checkpoint = ModelCheckpoint("G:\\sentiment-analysis-of-tweets-in-russian\\cnn\\cnn-trainable-{epoch:02d}-{val_f1:.2f}.hdf5", 
#                              monitor='val_f1', save_best_only=True, mode='max', period=1)
...
model.load_weights('G:\\sentiment-analysis-of-tweets-in-russian\\cnn\\cnn-trainable-03-0.78.hdf5')
